...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription(
      "Configura ou desabilita o sistema de autorooms, cria canais de voz pessoais"
    ),
   ...
   hope this helps visualise the code structure. If not just read ¯\_(ツ)_/¯, sorry if my code is unreadable :)  */
    ...
    if (!interaction.member.permissions.has(PermissionsBitField.Flags.Administrator))
      return await interaction.reply({
        content: "Apenas administradores do servidor podem executar este comando, capeta burro",
        ephemeral: true,
      });
      if (!interaction.guild.members.me.permissions.has(PermissionsBitField.Flags.ManageChannels)) {
        interaction.reply({
          content: 'Ô imbecil... Este recurso requer permissões de gerenciamento de canais, já que os autorooms criam canais quando um usuário se junta ao canal de origem.',
          ephemeral: true})
        return;
     }    
    ...
    const autoroomEmbed0 = new EmbedBuilder()
      ...
      .setDescription(
        `Bem-vindo ao setup de autorooms, por favor selecione uma opção\n
       Easy Setup: Um setup simples com alguma customização.\n
       Automatic Setup: Um setup pré-definido com nenhum input do usuário.\n
       Setup: Personalize tudo conforme suas especificações.`
      );
    ...
    if (autoroom) {
      ...
      const autoroomDisableEmbed0 = new EmbedBuilder()
        ...
        .setTitle("Autoroom Setup")
        .setDescription(
          `Autoroom já foi configurado neste servidor\n
          Você gostaria de alterar ou desabilitar os autorooms? \n
          Se sim, clique em desabilitar e execute este comando novamente se quiser alterá-lo`
        )
        .setFooter({ text: "*não deleta canais*" });
      ...
      switch (step) {
        case 1:
          const easySetupEmbed1 = new EmbedBuilder()
            .setColor("#e66229")
            .setTitle("Autoroom Easy Setup - Categoria")
            .setDescription(
              `Por favor selecione a categoria em que você deseja criar os autorooms \n
              *Quando os usuários se juntarem ao canal "Clique para criar um VC" este será a categoria onde o canal será criado.*
              `
            );
        ...
        case 2:
          ...
          const easySetupEmbed2 = new EmbedBuilder()
            .setColor("#e66229")
            .setTitle("Autoroom Easy Setup - Canal de origem")
            .setDescription(`Por favor selecione o canal em que os usuários se juntarão para criar seus autorooms \n 
            *Se você não criou um canal, por favor crie um e selecione-o, este será o canal em que os usuários se juntarão para criar seus autorooms*`);
        ...
        case 3:
          ...
          const easySetupEmbed3 = new EmbedBuilder()
            .setColor("#e66229")
            .setTitle("Autoroom Easy Setup - Confirmação")
            .setDescription(`São estes os ajustes corretos?\n
            Os usuários se juntarão a ${sourceChannel} para criar seus autorooms, que são nomeados **${data.name}**, quando eles se juntarem aos seus canais, eles serão criados na categoria #${categoryName}.\n
        ...
        case 4:
          ...
          const easySetupEmbed4 = new EmbedBuilder()
            .setColor("#e66229")
            .setTitle("Autoroom Easy Setup - Finalização")
            .setDescription(`Você finalizou o setup, se junte a ${sourceChannel4} para criar seu autoroom. \n Se você quiser desabilitar os autorooms, execute este comando novamente.`);
